LANGUAGE_NAME := tree-sitter-osgi-bundle-manifest
HOMEPAGE_URL := https://github.com/impure0xntk/tree-sitter-osgi-bundle-manifest
VERSION := 0.1.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/osgi-bundle-manifest '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/osgi-bundle-manifest
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/osgi-bundle-manifest
